<div align="center">
  ...
  [前端展示](https://blog.devnest.top) | [详细文档](https://blog.liushen.fun/posts/4dc716ec/)
...
* [ByteWyrm 友链朋友圈](https://blog.liushen.fun/fcircle/)
...
* 欢迎在issue中[提交](https://github.com/HxCodeWarrior/Friend-Circle-Lite/issues/20)以展示你独特的设计！
...
1. 如果需要修改爬虫设置或邮件模板等配置，需要修改仓库中的 `config.yaml` 文件：
   ...
   - **爬虫相关配置**
     ...
     spider_settings:
       enable: true
       json_url: "https://blog.devnest.top/friend.json"
       article_count: 5
       merge_result:
         enable: true
         merge_json_url: "https://blog.devnest.top"
     ```
   ...
   - **邮箱 issue 订阅功能配置**
     ...
     rss_subscribe:
       enable: true
       github_username: HxCodeWarrior
       github_repo: Friend-Circle-Lite
       your_blog_url: https://blog.devnest.top/
     ```
   ...
   - **特定 RSS 配置**
     ...
     specific_RSS:
       - name: "Redish101"
         url: "https://blog.devnest.top/atom.xml"
      # - name: "無名小栈"
...
**注意，以下可能仅适用于hexo-theme-butterfly或部分类butterfly主题，如果你是其他主题，可以自行适配，理论上只要存在友链数据文件都可以整理为该类型，甚至可以自行整理为对应json格式后放到 `/source` 目录下即可，格式可以参考：`https://blog.devnest.top/friend.json` **
...
<script>
    if (typeof UserConfig === 'undefined') {
        var UserConfig = {
            // 填写你的fc Lite地址
            private_api_url: 'https://blog.devnest.top/',
...
<link rel="stylesheet" href="https://fastly.jsdelivr.net/gh/HxCodeWarrior/Friend-Circle-Lite/main/fclite.min.css">
<script src="https://fastly.jsdelivr.net/gh/HxCodeWarrior/Friend-Circle-Lite/main/fclite.min.js"></script>
```
...
```bash
git clone https://github.com/HxCodeWarrior/Friend-Circle-Lite.git
...
如果遇到任何问题或有建议，请[提交一个 issue](https://github.com/HxCodeWarrior/Friend-Circle-Lite/issues)。欢迎贡献代码！

## Star增长曲线

[![Star History Chart](https://api.star-history.com/svg?repos=HxCodeWarrior/Friend-Circle-Lite&type=Timeline)](https://star-history.com/#HxCodeWarrior/Friend-Circle-Lite&Timeline)